...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin Subscription Edit</title>
      ...
      <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>innova-admin/all-subscription">Subscription</a></li>
                <li class="breadcrumb-item active">Subscription Update</li>
              </ol>
              <!-- END BREADCRUMB -->
            </div>
          </div>
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <h2 class="mw-80">Update your Subscription.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/subscription-update/<?php echo $subscription[0]->subscription_id; ?>">
              <input type="hidden" name="subscription_id" id="subscription_id" value="<?php echo $subscription[0]->subscription_id;?>">
                <div class="row clearfix pt-2">
                  <div class="col-xl-6 controls">
                    <div class="form-group form-group-default controls">
                      <label>Subscription</label>
                      <?php echo stripslashes($subscription[0]->subscription_name); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-xl-3">
                    <div class="form-group form-group-default">
                      ...
                      <input type="number" class="form-control" name="subscription_amt" id="subscription_amt" value="<?php echo stripslashes($subscription[0]->subscription_amt); ?>" required>
                    </div>
                  </div>
                </div>
