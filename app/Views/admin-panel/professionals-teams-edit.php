...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin Professionals & teams Edit</title>
      ...
      <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Professionals & teams Update</li>
              </ol>
              <!-- END BREADCRUMB -->
            </div>
          </div>
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <h2 class="mw-80">Update your Professionals & teams.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/professionals-teams-edit/<?php echo $professionals[0]->prfteam_id; ?>">
              <input type="hidden" name="prfteam_id" id="prfteam_id" value="<?php echo $professionals[0]->prfteam_id; ?>">
                  ...
                  <div class="col-xl-12">
                    <div class="form-group form-group-default controls">
                      <label>Upload Icon</label>
						<?php 
                        if($professionals[0]->prfteam_logo!=='' && file_exists('uploads/othersfiles/'.$professionals[0]->prfteam_logo))
                        {
							$prfteam_logo = base_url().'uploads/othersfiles/'.$professionals[0]->prfteam_logo;
                        }
                        else
                        {
                        ...
                        ?>
                      <img src="<?php echo $prfteam_logo;?>" style="width:160px">
                      <input type="file" class="form-control" name="prfteam_logo" id="prfteam_logo">
                      <input type="hidden" name="old_logo" id="old_logo" value="<?php echo $professionals[0]->prfteam_logo; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default controls">
                      <label>Link</label>
                      <input type="text" class="form-control" name="prfteam_link" id="prfteam_link" value="<?php echo stripslashes($professionals[0]->prfteam_link); ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix">
                  <div class="col-xl-6 controls">
                    ...
                    <select class="form-select" id="prfteam_status" name="prfteam_status" data-init-plugin="select2">
                        <option value="Y" <?php if($professionals[0]->prfteam_status == 'Y') { ?> selected <?php } ?>>Active</option>
                        <option value="N" <?php if($professionals[0]->prfteam_status == 'N') { ?> selected <?php } ?>>Inactive</option>
                    </select>
                  </div>
                </div>
