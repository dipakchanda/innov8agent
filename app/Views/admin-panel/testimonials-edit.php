        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              ...
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/testimonials-edit/<?php echo $testimonials[0]->testimonials_id; ?>">
              <input type="hidden" name="testimonials_id" id="testimonials_id" value="<?php echo $testimonials[0]->testimonials_id; ?>">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      ...
                      <input type="text" class="form-control" name="testimonialsby" id="testimonialsby" value="<?php echo stripslashes($testimonials[0]->testimonialsby); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      ...
                      <input type="text" class="form-control" name="testimonialstype" id="testimonialstype" value="<?php echo stripslashes($testimonials[0]->testimonialstype); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-2">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default controls">
                      <label>Image</label>
						<?php 
                        if($testimonials[0]->testimonialsimage!=='' && file_exists('uploads/testimonials/'.$testimonials[0]->testimonialsimage))
                        {
							$testimonialsimage = base_url().'uploads/testimonials/'.$testimonials[0]->testimonialsimage;
                        }
                        else
                        {
                        ...
                        ?>
                      <img src="<?php echo $testimonialsimage;?>" style="width:50px">
                      <input type="file" class="form-control" name="testimonialsimage" id="testimonialsimage">
                      <input type="hidden" name="old_testimonialsimage" id="old_testimonialsimage" value="<?php echo $testimonials[0]->testimonialsimage; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-3">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default">
                      ...
                      <textarea class="form-control" id="testimonialsdesc" name="testimonialsdesc" rows="3" style="min-height:150px" required><?php echo stripslashes($testimonials[0]->testimonialsdesc); ?></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 controls">
                    ...
                    <select class="form-select" id="test_position" name="test_position" data-init-plugin="select2">
                        <option value="1" <?php if($testimonials[0]->test_position == '1') { ?> selected <?php } ?>>Left</option>
                        <option value="2" <?php if($testimonials[0]->test_position == '2') { ?> selected <?php } ?>>Right</option>
                    </select>
                  </div>
                  ...
                  <div class="col-xl-6 controls">
                    ...
                    <select class="form-select" id="testimonialsstatus" name="testimonialsstatus" data-init-plugin="select2">
                        <option value="Y" <?php if($testimonials[0]->testimonialsstatus == 'Y') { ?> selected <?php } ?>>Active</option>
                        <option value="N" <?php if($testimonials[0]->testimonialsstatus == 'N') { ?> selected <?php } ?>>Inactive</option>
                    </select>
                  </div>
                </div>
