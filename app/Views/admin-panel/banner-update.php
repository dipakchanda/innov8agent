      ...
      <div class="content ">
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="alert alert-success mt-2" role="alert" id="cat-add" style="display:block">Banner updated successfully completed</div>
            <?php } ?>
            
            <?php if(session()->get('fail')) { ?>
            <div class="alert alert-danger mt-2" role="alert" id="cat-add" style="display:block">Banner updated failed</div>
            <?php } ?>

            <div class="card-body">
              <h2 class="mw-80">Update your Banner.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/banner-update">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      <label>Heading</label>
                      <textarea class="form-control" id="banner_heading" name="banner_heading" rows="3" style="min-height:80px" required><?php echo stripslashes($banner[0]->banner_heading); ?></textarea>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-xl-12">
                    <div class="form-group form-group-default controls">
                      <label>Upload Icon</label>
                        ...
                        ?>
                      <img src="<?php echo $banner_image;?>" style="width:200px; padding-bottom:15px">
                      <input type="file" class="form-control" name="banner_image" id="banner_image">
                      <input type="hidden" name="old_icon" id="old_icon" value="<?php echo $banner[0]->banner_image; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-3">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default">
                      ...
                      <textarea class="form-control" id="banner_desc" name="banner_desc" rows="3" style="min-height:120px" required><?php echo stripslashes($banner[0]->banner_desc); ?></textarea>
                    </div>
                  </div>
                </div>
