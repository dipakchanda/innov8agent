...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin Services Highlights Add</title>
      ...
      <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Services Highlights Add</li>
              </ol>
              <!-- END BREADCRUMB -->
            </div>
          </div>
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <h2 class="mw-80">Get started with your Services Highlights.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/services-highlights-add">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      <label>Title</label>
                      <input type="text" class="form-control" name="services_title" id="services_title" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-2">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default controls">
                      ...
                      <img src="<?php echo base_url(); ?>admin-panel/assets/img/noimage.jpg" style="width:50px">
                ...
                <div class="row clearfix pt-3">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default required">
                      ...
                      <textarea class="form-control" id="services_desc" name="services_desc" rows="3" style="min-height:80px" required></textarea>
                    </div>
                  </div>
                </div>
