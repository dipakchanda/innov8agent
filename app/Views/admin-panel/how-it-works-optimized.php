...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin AI Real Estate Optimized Update</title>
      ...
      <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">AI Real Estate Optimized Update</li>
              </ol>
              <!-- END BREADCRUMB -->
            </div>
          </div>
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="alert alert-success mt-2" role="alert" id="cat-add" style="display:block">AI Real Estate Optimized updated successfully completed</div>
            <?php } ?>
            
            <?php if(session()->get('fail')) { ?>
            <div class="alert alert-danger mt-2" role="alert" id="cat-add" style="display:block">AI Real Estate Optimized updated failed</div>
            <?php } ?>

            <div class="card-body">
              <h2 class="mw-80">Update your AI Real Estate Optimized.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/how-it-works-optimized">
