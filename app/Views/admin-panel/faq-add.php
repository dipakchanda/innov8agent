      ...
      <div class="content ">
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <h2 class="mw-80">Add your FAQ.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/faq-add">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      <label>Question</label>
                      <input type="text" class="form-control" name="faq_question" id="faq_question" value="" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-3">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default">
                      <label>Answer</label>
                      <textarea class="form-control" id="faq_answer" name="faq_answer" rows="3" style="min-height:150px" required></textarea>
                    </div>
                  </div>
                </div>
