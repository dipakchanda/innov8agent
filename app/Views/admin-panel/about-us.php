...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin About Us Update</title>
      ...
      <div class="content ">
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="alert alert-success mt-2" role="alert" id="cat-add" style="display:block">About Us updated successfully completed</div>
            <?php } ?>
            
            <?php if(session()->get('fail')) { ?>
            <div class="alert alert-danger mt-2" role="alert" id="cat-add" style="display:block">About Us updated failed</div>
            <?php } ?>

            <div class="card-body">
              <h2 class="mw-80">Update your About Us.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/about-us">
                  ...
                  <div class="col-xl-12">
                    <div class="form-group form-group-default controls">
                      <label>Upload Video</label>
                        ...
                        ?>
                      <?php if($cms_image!='') { ?>  
                      <div style="padding-bottom:10px">Please click <a href="<?php echo $cms_image;?>" download>Here</a> To download the uploaded video.</div>
                      <?php } ?>
