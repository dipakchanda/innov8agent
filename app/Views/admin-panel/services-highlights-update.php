...
<head>
  ...
  <meta charset="utf-8" />
  <title>Admin Services Highlights Update</title>
      ...
      <div class="content ">
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="alert alert-success mt-2" role="alert" id="cat-add" style="display:block">Services Highlights updated successfully completed</div>
            <?php } ?>
            
            <?php if(session()->get('fail')) { ?>
            <div class="alert alert-danger mt-2" role="alert" id="cat-add" style="display:block">Services Highlights updated failed</div>
            <?php } ?>

            <div class="card-body">
              <h2 class="mw-80">Update your Services Highlights.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/services-highlights-update">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      <label>Services Highlights</label>
                      <textarea class="form-control" id="cms_desc" name="cms_desc" rows="3" style="min-height:80px" required><?php echo stripslashes($cms[0]->cms_desc); ?></textarea>
                    </div>
                  </div>
                </div>
