      ...
      <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>innova-admin/faq">FAQ</a></li>
        ...
        <div class=" container-fluid   container-fixed-lg p-t-30">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <h2 class="mw-80">Update your FAQ.</h2>
              <form id="form-personal" class="p-t-15" role="form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>innova-admin/faq-edit/<?php echo $faq[0]->faq_id; ?>">
              <input type="hidden" name="faq_id" id="faq_id" value="<?php echo $faq[0]->faq_id; ?>">
                <div class="row clearfix pt-2">
                  <div class="col-xl-12 controls">
                    <div class="form-group form-group-default required controls">
                      <label>Question</label>
                      <input type="text" class="form-control" name="faq_question" id="faq_question" value="<?php echo stripslashes($faq[0]->faq_question); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix pt-3">
                  <div class="col-xl-12">
                    <div class="form-group form-group-default">
                      <label>Answer</label>
                      <textarea class="form-control" id="faq_answer" name="faq_answer" rows="3" style="min-height:150px" required><?php echo stripslashes($faq[0]->faq_answer); ?></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix">
                  <div class="col-xl-6 controls">
                    ...
                    <select class="form-select" id="faq_status" name="faq_status" data-init-plugin="select2">
                        <option value="Y" <?php if($faq[0]->faq_status == 'Y') { ?> selected <?php } ?>>Active</option>
                        <option value="N" <?php if($faq[0]->faq_status == 'N') { ?> selected <?php } ?>>Inactive</option>
                    </select>
                  </div>
                </div>
