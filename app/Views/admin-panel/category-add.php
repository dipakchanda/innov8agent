          ...
          <!-- START CONTAINER FLUID -->
           <div class=" container-fluid   container-fixed-lg p-t-30">
            ...
            <div class="card card-default">
              ...
              <div class="card-body">
                    <h2 class="mw-80">Get started with your category.</h2>
                    <form id="form-personal" role="form" autocomplete="off" method="post" action="<?php echo base_url(); ?>innova-admin/category-add">
