                ...
                <div class="row align-items-center gap-y1">
                    ...
                    <div class="col-lg-9 col-md-8">
                        <h3>
                            ...
                            <small><?php echo stripslashes($project[0]->question_desc); ?></small>
                        </h3>
                    </div>
                </div>
            </div>
            <div class="col-12 bodySec">
                <div class="row gap-y2">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <form name="create_<?php echo $project[0]->prompt_question_id; ?>" id="create_<?php echo $project[0]->prompt_question_id; ?>" method="post" action="">
                            ...
                            ?>
                                ...
                                <?php if ($filed_type == 'headbox') { ?>
                                    ...
                                    <div class="form-group">
                                        <h6><label for=""><?php echo $filed_label; ?> <sup>*</sup></label></h6>
                                    </div>
                                ...
                                ?>
                                    <div class="form-group">
                                        <label for=""><?php echo $filed_label; ?> <sup>*</sup></label>
                                        <div class="inputBox rightIcon">
                                            <select name="<?php echo $filed_name; ?>" id="<?php echo $filed_name; ?>" class="form-control" required>
                                                <option value="">Select</option>
                                                <?php for ($i = 0; $i < count($filed_value); $i++) {  ?>
                                                    <option value="<?php echo $filed_value[$i]; ?>"><?php echo $filed_value[$i]; ?></option>
                                                <?php } ?>
                                            </select>
                                ...
                                <?php if ($filed_type == 'textarea') { ?>
                                    <div class="form-group">
                                        <label for=""><?php echo $filed_label; ?> <sup>*</sup></label>
                                        <div class="inputBox rightIcon">
                                            <textarea class="form-control" name="<?php echo $filed_name; ?>" id="<?php echo $filed_name; ?>" style="resize:none" required></textarea>
                                        </div>
                                ...
                                <?php if ($filed_type == 'textbox') { ?>
                                    <div class="form-group">
                                        <label for=""><?php echo $filed_label; ?> <sup>*</sup></label>
                                        <div class="inputBox rightIcon">
                                            <input type="text" class="form-control" name="<?php echo $filed_name; ?>" id="<?php echo $filed_name; ?>" value="" placeholder="" required>
                                        </div>
                                        <small>Select your product or service.</small>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="">
                                <button class="btn btnPrimary w-100" id="submit-button">Create It <em class="icon-arrowRight"></em></button>
                            </div>
                        </form>
                    </div>
