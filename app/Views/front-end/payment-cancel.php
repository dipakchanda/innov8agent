<?php $pagename = 'cancel' ; include 'include/header.php'; ?>
        ...
        <div class="row gap-y2">
            <div class="col-12 text-center">
                <div class="sectionTitle" id="scrollHere">
                    <h6>
                        <em class="icon-arrowBottomRight"></em> Payment Failed
                    </h6>
                    <h4 class="titleL">
                        Sorry Your Payment Has been failed due some technical error
                    </h4>
                    <p>
                       Please <a href="<?php echo base_url()?>subscription">click here</a> to Subscribe again
                    </p>
